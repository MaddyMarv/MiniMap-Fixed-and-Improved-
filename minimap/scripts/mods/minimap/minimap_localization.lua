local loc = {
    ...
    unit_threat_adamant_vis = {
        en = "Companion Target Skull",
        ["zh-cn"] = "同伴目标骷髅标记",
    },
    player_vis = {
        en = "Players",
    ...
    hidden = {
        en = "Show as normal (no status icons)",
        ["zh-cn"] = "显示为正常（无状态图标）",
    },
    non_glowing = {
        en = "Non-glowing icons (colored)",
        ["zh-cn"] = "非发光图标（彩色）",
    },
    non_glowing_with_rings = {
        en = "Non-glowing icons with rings",
        ["zh-cn"] = "带圆环的非发光图标",
    },
    glowing_with_rings = {
        en = "Glowing icons with rings",
        ["zh-cn"] = "带圆环的发光图标",
    },
    glowing_no_rings = {
        en = "Glowing icons without rings",
        ["zh-cn"] = "无圆环的发光图标",
    },
    hide_bots = {
        en = "Hide bots",
    ...
    own_dog_vis = {
        en = "Show Your Own Dog",
        ["zh-cn"] = "显示你自己的猎犬",
    },
    teammate_dog_vis = {
        en = "Show Teammates' Dogs",
        ["zh-cn"] = "显示队友的猎犬",
    },
    show_in_hub = {
        en = "Show in Hub",
    ...
    show_in_shooting_range = {
        en = "Show in Shooting Range/Psykhanium",
        ["zh-cn"] = "在灵能室显示",
    },
    show_when_dead = {
        en = "Show When Dead",
    ...
    enemy_radar_priority_mode_threat = {
        en = "Threat (Type + Health)",
        ["zh-cn"] = "威胁度（类型+生命值）",
    },
    enemy_radar_priority_mode_distance = {
        en = "Distance (3D)",
        ["zh-cn"] = "距离（3D）",
    },
    enemy_clustering = {
        en = "Enemy Grouping (Clustering)",
        ["zh-cn"] = "敌人分组（聚类）",
    },
    enemy_clustering_enabled = {
        en = "Enable Enemy Grouping",
        ["zh-cn"] = "启用敌人分组",
    },
    enemy_clustering_radius = {
        en = "Grouping Radius (meters)",
        ["zh-cn"] = "分组半径（米）",
    },
    enemy_clustering_threshold = {
        en = "Minimum Group Size",
        ["zh-cn"] = "最小分组大小",
    },
    enemy_clustering_show_type = {
    ...
    distance_marker_players = {
        en = "Show Distance on Players",
        ["zh-cn"] = "在玩家上显示距离",
    },
    distance_marker_companions = {
        en = "Show Distance on Dogs/Companions",
        ["zh-cn"] = "在猎犬/同伴上显示距离",
    },
    distance_marker_enemies = {
        en = "Show Distance on Enemies",
        ["zh-cn"] = "在敌人上显示距离",
    },
    distance_marker_objectives = {
        en = "Show Distance on Objectives",
        ["zh-cn"] = "在目标上显示距离",
    },
    distance_marker_interactables = {
        en = "Show Distance on Interactables",
        ["zh-cn"] = "在可交互物品上显示距离",
    },
    distance_marker_pings = {
        en = "Show Distance on Pings",
        ["zh-cn"] = "在标记上显示距离",
    },
    ...
    display_name_players = {
        en = "Show Player Names",
        ["zh-cn"] = "显示玩家名称",
    },
